...
The National Medical Commission's State Medical Council directory lists the **Telangana State Medical Council (TSMC)**.

**Address:**  
P.B. 523, Sultan Bazar, Hyderabad – 500095, Telangana

**Telephone:**  
040-24657639

**Official website:**  
https://www.tsmconline.in

The TSMC should be treated as a primary source for state-level medical registration matters.
...
- FMGE/FMGL examination documentation
...
Do not assume that every institution requires exactly the same documents.

---

# 6. Questions to Ask an Institution

Before accepting an internship position, obtain clear information about:
...
- Is any fee payable?
- What is the official amount?
- Is an official receipt provided?

### Stipend

If a stipend is applicable:
...
Community experiences can be useful for identifying practical problems encountered by FMGs in Telangana.

However:

> A personal experience is not automatically evidence of a state-wide rule.

Community reports should therefore be labelled separately from official requirements.

Future versions of this page may include:

- Verified FMG experiences
...
Such information should include the date and source wherever possible.
...
| Category | Meaning |
|---|---|
| **Official regulation** | Requirement established by a competent authority |
| **Institutional requirement** | Requirement imposed by a particular institution |
| **Community experience** | Experience reported by an FMG |
| **Interpretation** | Plain-language explanation of an official rule |

This distinction should be preserved throughout the FMG Open Guide.
